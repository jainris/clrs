...
flags.DEFINE_enum('processor_memory', 'none',
                  ['none', 'stack', 'queue', 'deque', 'priority_queue',
                   'priority_queue_v1', 'priority_queue_v2', 'priority_queue_v2_sig',
                   'priority_queue_v2_ph', 'priority_queue_v2_ph_mph',
                   ...
                   'priority_queue_hardcoded_2_delay', 'priority_queue_hardcoded_3_delay',
                   'priority_queue_hardcoded_delay', 'priority_queue_hardcoded_3_return_u',
                   'priority_queue_hardcoded_3_return_u_delay'],
...
flags.DEFINE_boolean('pmem_direct_output', True,
                     'Directly use the output from the memory module as'
                     'the message')
flags.DEFINE_boolean('pmem_only_pq_messages', False,
                     'Only use priority queue messages, ignore normal messages.')
...
def main(unused_argv):
  ...
  memory_modules_args = {
    ...
    'direct_output': FLAGS.pmem_direct_output,
    'only_pq_messages': FLAGS.pmem_only_pq_messages
  }
